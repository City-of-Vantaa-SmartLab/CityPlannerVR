...
public class LocalObjectSpawner : MonoBehaviour

{
    ...
    public List<GameObject> itemsInSpawner;
    ...
    public void DestroyItem()
    {
        ...
        foreach (Transform child in parent) clonedItems.Add(child.gameObject);
        foreach (GameObject childs in clonedItems) Destroy(childs);
